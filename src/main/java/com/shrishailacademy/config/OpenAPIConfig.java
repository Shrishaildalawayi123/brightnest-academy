 ...
 */
@Configuration
@OpenAPIDefinition(info = @Info(title = "BrightNest Academy API", version = "1.0.0", description = """
        ...
        """, contact = @Contact(name = "BrightNest Academy", email = "admin@brightnest-academy.com", url = "https://brightnest-academy.com"), license = @License(name = "Proprietary", url = "https://brightnest-academy.com/license")), servers = {
        @Server(url = "http://localhost:8080", description = "Development Server"),
        @Server(url = "https://api.brightnest-academy.com", description = "Production Server")
}, security = {
        @SecurityRequirement(name = "bearerAuth")
})
@SecurityScheme(name = "bearerAuth", type = SecuritySchemeType.HTTP, scheme = "bearer", bearerFormat = "JWT", description = "JWT authentication. Login via /api/auth/login to obtain token.")
