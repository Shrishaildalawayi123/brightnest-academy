...
public interface AttendanceRepository extends JpaRepository<Attendance, Long> {
        ...
        Optional<Attendance> findByUserIdAndCourseIdAndAttendanceDateAndTenantId(Long userId, Long courseId,
                        LocalDate date,
                        Long tenantId);
        ...
        List<Attendance> findByCourseIdAndAttendanceDateBetweenAndTenantId(Long courseId, LocalDate start,
                        LocalDate end,
                        Long tenantId);
